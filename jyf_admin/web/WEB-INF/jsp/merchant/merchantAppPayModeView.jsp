...
<head>
    ...
    <title>商户App支付管理 - ${SITE_NAME}</title>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $('#config_batch_action').click(function() {
                ...
                $checked.each(function(i) {
                    ...
                    configBatchForm.append('<input type="hidden" name="merchantAppPayModeList[' + i + '].id" value="' + config_id + '" />');
                });
            ...
            $('#batch_action').click(function() {
                ...
                $checked.each(function(i) {
                    var id = $(this).val();
                    var mode_id = $('#mode_' + id).val();
                    batchForm.append('<input type="hidden" name="merchantSelectablePayModeList[' + i + '].id" value="' + mode_id + '" />');
                });
                batchForm.submit();
            });
        });
        ...
        function optStatus(obj, config_id) {
            $.ajax({
                url:"<c:url value="/merchant/merchantAppPayMode.do"/>",
                data:{action:"optStatus","merchantAppPayMode.id":config_id},
                type:"post",
                dataType:"json",
    ...
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active">商户App支付配置</li>
            </ul>

            <div class="row">
                <form class="form-horizontal" role="form" id="configBatchForm" action="<c:url value="/merchant/merchantAppPayMode.do"/>" method="post">
                ...
                <div class="col-md-6">
                    <div class="panel panel-primary">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                            <s:iterator value="merchantAppPayModeList" status="index">
                                <tr>
                                    <td>
                ...
                <form class="form-horizontal" role="form" id="batchForm" action="<c:url value="/merchant/merchantAppPayMode.do"/>" method="post">
                            ...
                            <s:iterator value="merchantSelectablePayModeList" status="index">
                                <tr>
                                    <td>
                                        ...
                                        <input type="hidden" id="mode_${index.count - 1}" value="${id}"/>
                                    </td>
                                    <td>${payType.value}</td>
                                    <td>${payType.name}</td>
                                </tr>
