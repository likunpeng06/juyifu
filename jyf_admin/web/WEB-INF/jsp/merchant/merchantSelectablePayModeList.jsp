...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <form class="form-inline" role="form" action="<c:url value='/merchant/merchantSelectablePayMode.do'/>" method="post">
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <s:iterator value="merchantList">
                        <tr>
                            ...
                            <td>${status.name}</td>
                            <td><a href="<c:url value="/merchant/merchantSelectablePayMode.do?action=view&merchant.id=${id}"/>">支付方式配置</a></td>
                        </tr>
                    </s:iterator>
                    </tbody>
                </table>
