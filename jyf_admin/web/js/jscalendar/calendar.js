...
/// detect a special case of "admin browser"
			...
			case 400:
			    ...
			    cal.params["inputField"].value="";
			     Calendar.removeClass(el, "hilite");
			       cal.callCloseHandler();
			    return;
			//这个地方的意思是，当点击清除后，清空inputfiled中的值
			/*case 400:
			Calendar.removeClass(el, "hilite");
...
Calendar.prototype.create = function (_par) {
	...
	//this.title = hh("", title_length-5, 300);//这里要增加一个清除按钮，所以总长度要减一个单位
	//this.title.className = "title";
	if(this.showClean){
	      hh(Calendar._TT["CLEAN_TITLE"], 1, 400).ttip =Calendar._TT["CLEAN"];//我这里设置了一个为1000的标志
	}
	/***************************addend*****************************/
...
Calendar.prototype.hideShowCovered = function () {
	if (!Calendar.is_ie5 && !Calendar.is_ie6 && !Calendar.is_opera)
		return;
